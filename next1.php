...
$conn = new mysqli($host, $userName, $password, $dbName);
 if((isset($_POST['id'])&& $_POST['dat'] !='') && (isset($_POST['fname'])&& $_POST['title'] !=''))
{
$id= $conn->real_escape_string($_POST['id']);
$dat = $conn->real_escape_string($_POST['dat']);
$fname = $conn->real_escape_string($_POST['fname']);
$title = $conn->real_escape_string($_POST['title']);
$no = $conn->real_escape_string($_POST['no']);
$comment=  $conn->real_escape_string($_POST['comment']);
$file= $conn->real_escape_string($_FILES['file']['name']);
move_uploaded_file($_FILES['file']['tmp_name'], "cocurricular/$file");

$path=$_SERVER['HTTP_REFERER']."cocurricular/".$file;
$sql="INSERT INTO cocurricular (user_id,Dat, Fname, Nodays,Aname,wmm,img) VALUES ('".$id."','".$dat."', '".$fname."', '".$no."','".$title."','".$comment."','".$path."')";
...
<h1 style="text-align: center">Co Curricular Activities</h1>
</head>
<body>
<h2 style="text-align: right; text-decoration-color: red"><a href = "logout.php">Sign Out</a></h2>
<form action="next1.php" method="post" enctype="multipart/form-data">
  Enter Your User Id: <input class="input1" name="id" required>
  <br><br><br>
Select The Date: <input type="date" name="dat" id="dateofbirth" required="">
<br><br><br>
Name Of The Faculty: <input class="input" type="text" name="fname" >
<br><br><br>
Name Of the Activity: <input class="input1" type="text" name="title">
<br><br><br>

Number Of Days: <input class="input2" type="number" id="myNumber" name="no" value="2">
<br><br><br>
  <label for="fname"><b>Few Words On Memorial Moments</b></label>
